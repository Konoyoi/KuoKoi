...
class Community:
    ...
    **Parameters:**
    ...
    def fetch_wiki(self, wikiId: str, comId: Union[str, int] = None) -> CWiki: #TODO: Add Wiki class
        ...
        :type comId: Union[str, int]
        :return: An `CWiki` object containing information about the request status and the fetched wiki.

        The `community` decorator is used to ensure that the user is logged in and the community ID is present.

        `CWiki`:

        A `CWiki` object contains the following attributes:
        ...
        - `votesCount`: The total number of votes the blog has received.
        - `ndcId`: The ID of the community where the blog is located.
        - `createdTime`: The time the wiki was created.
        - `endTime`: The time the blog ends.
        - `commentsCount`: The total number of comments the blog has received.
    ...
    @community
    def disable_wiki(self, wikiId: str, reason: str = None, comId: Union[str, int] = None) -> ApiResponse:
        """
        Disables a wiki in the current or specified community.

        :param wikiId: The ID of the wiki to disable.
        :type wikiId: str
        :param reason: An optional reason for disabling the wiki.
        :type reason: str
        :param comId: The ID of the community where the blog is located. If not provided, the current community ID is used.
        :type comId: Union[str, int]
        :return: An `ApiResponse` object containing information about the request status.
        ...
        **Example usage:**
        ...
        >>> response = client.community.disable_wiki(wikiId="1111-1111-1111-1111")
        ... if response.statuscode == 0:
        ...     print("Wiki disabled successfully!")
        ... else:
        ...     print("Failed to disable wiki.")

        To disable a blog with ID "2222-2222-2222-2222" in a community with ID "123" and provide a reason:

        >>> response = client.community.disable_wiki(blogId="2222-2222-2222-2222", reason="This wiki violates community guidelines.", comId=123)
        ... if response.statuscode == 0:
        ...     print("Wiki disabled successfully!")
        ... else:
        ...     print("Failed to disable wiki.")
    ...
    @community
    def unhide_user(self, userId: str, reason: str = None, comId: Union[str, int] = None) -> ApiResponse:
        """
        Unhides a user profile in the current or specified community.

        :param userId: The ID of the user to unhide.
        :type userId: str
        :param reason: An optional reason for unhiding the user.
        :type reason: str
        :param comId: The ID of the community where the user profile is located. If not provided, the current community ID is used.
        :type comId: Union[str, int]
        :return: An `ApiResponse` object containing information about the request status.
        ...
        - `message` (str): A message indicating whether the user was successfully unhidden.
        - `statuscode` (int): The status code of the API response.
        - `duration` (str): The duration of the API request.
        - `timestamp` (str): The timestamp of the API request.
        ...
        **Example usage:**
        ...
        To unhide a user with ID "1111-1111-1111-1111" in a community with ID "123" and provide a reason:

        >>> response = client.community.unhide_user(userId="1111-1111-1111-1111", reason="This user have been unhidden.", comId=123)
        ... if response.statuscode == 0:
        ...     print("User unhidden successfully!")
        ... else:
        ...     print("Failed to unhide user.")
